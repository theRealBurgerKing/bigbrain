...
const Button = styled.button.withConfig({
  ...
  padding: _isMobile ? '1.5vh 3vw' : '1vh 2vw',
  ...
  return (
    <Container>
      <Editor _isMobile={_isMobile}>
        <Title _isMobile={_isMobile}>Edit Game: {game.name}</Title>
        ...
        <InputGroup _isMobile={_isMobile}>
          <Subtitle _isMobile={_isMobile}>Edit</Subtitle>
          <Label id="gameNameLabel" _isMobile={_isMobile}>
            Game Name:
            <Input
              _isMobile={_isMobile}
              type="text"
          ...
          <div>
            <Label id="thumbnailLabel" _isMobile={_isMobile}>
              Thumbnail:
              <FileInput
                _isMobile={_isMobile}
                type="file"
